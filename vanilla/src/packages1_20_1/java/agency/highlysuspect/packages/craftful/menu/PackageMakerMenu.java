...
public class PackageMakerMenu extends AbstractContainerMenu {
	...
	public static final ResourceLocation FRAME_BG = Packages.rl("package_gui_slot_icons/slot_frame");
	public static final ResourceLocation INNER_BG = Packages.rl("package_gui_slot_icons/slot_inner");
	public static final ResourceLocation DYE_BG = Packages.rl("package_gui_slot_icons/slot_dye");
	public static final ResourceLocation EXTRA_BG = Packages.rl("package_gui_slot_icons/slot_extra");
