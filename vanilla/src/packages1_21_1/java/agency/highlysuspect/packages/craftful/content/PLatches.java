...
public class PLatches {
	...
	public static class DataComponentTypes {
		public static final Latch<DataComponentType<ImmutablePackageContents>> PACKAGE_CONTENTS = Latch.open(NewRegType.DATA_COMPONENT_TYPE, Packages.id("cont"));
		public static final Latch<DataComponentType<PackageStyle>> PACKAGE_STYLE = Latch.open(NewRegType.DATA_COMPONENT_TYPE, Packages.id("style"));
	}
}
